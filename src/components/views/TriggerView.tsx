    ...
    <div className="space-y-4">
      ...
      {!selectedTrigger ? (
        <div className="grid grid-cols-1 gap-2">
          {triggerOptions.map((option) => (
            <button
              ...
              className="text-left p-4 rounded-lg transition-colors bg-white/50 dark:bg-gray-800/50 text-gray-700 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-900/30"
            >
        ...
        <div className="mt-4 p-3 bg-white/50 dark:bg-gray-800/50 rounded-lg">
          <h4 className="text-sm font-medium text-purple-700 dark:text-purple-200 mb-2">
            Suggestions
          </h4>
          <ul className="list-disc list-inside text-sm text-gray-700 dark:text-gray-300">
            {triggerOptions.find(option => option.id === selectedTrigger)?.suggestions?.map((suggestion, index) => (
